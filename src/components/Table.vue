          ...
          <tbody class="bg-white">
            <tr v-for="activity in activities" v-bind:key="activity.date">
              ...
              <td
                class="px-6 py-4 whitespace-no-wrap border-b text-sm text-gray-500 border-gray-200"
              >{{ activity.value }}</td>
              <td class="px-6 py-4 whitespace-no-wrap border-b text-gray-400 border-gray-200">
                <div class="w-full fill-current flex items-center justify-end">
                  <svg @click="removeActivity(activity)" class="w-4 h-4 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path
